                    ...
                    <form id="team" data-parsley-validate class="form-horizontal form-label-left" method="post" action="" enctype="multipart/form-data">
                       ...
                       <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="name" required="required" name="name" class="form-control col-md-7 col-xs-12" value="<?php echo $tid[0]->name; ?>">
                        </div>
                      </div><br>
                       ...
                       <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="post" required="required" name="post" class="form-control col-md-7 col-xs-12" value="<?php echo $tid[0]->post; ?>">
                        </div>
                      </div><br>
                       ...
                       <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <textarea id="message" required="required" name="message" class="form-control col-md-7 col-xs-12 ckeditor"><?php echo $tid[0]->message; ?></textarea>
                        </div>
                      </div><br>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                        <img src="images/<?php echo $tid[0]->feature_image; ?>" class="img-responsive" required="required" width="300">
