...
if(isset($_POST['btnUpdate'])){
  ...
  $gallery->set('feature_image',$name);
 }
}
else{
	$error['feature_image']="Upload an image";
}
$gallery->set('title',$_POST['title']);


  $gallery->set('feature_key',$_POST['feature_key']);
  $gallery->set('description',$_POST['description']);
                    ...
                    <form id="galleryform" data-parsley-validate class="form-horizontal form-label-left" method="post" action="" enctype="multipart/form-data">
                     ...
                     <div class="form-group">
                      ...
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="description">Description 
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <textarea type="text" id="description" required="required" name="description" class="form-control col-md-7 col-xs-12 ckeditor"><?php echo $gtdata[0]->description; ?></textarea>
                        </div>
                      </div><br>
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          <input type="submit" name="btnUpdate" class="btn btn-success" value="Update Gallery"/>
